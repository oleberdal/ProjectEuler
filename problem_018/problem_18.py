...
def maximum_path_from_top_to_bottom(pyramid):
    ...
    return pyramid[0][0] + max(maximum_path_from_top_to_bottom(pyramid_a), maximum_path_from_top_to_bottom(pyramid_b))
...
def main():
    ...
    solution = maximum_path_from_top_to_bottom(data)
